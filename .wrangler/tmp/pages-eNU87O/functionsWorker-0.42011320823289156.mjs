...
function generateCandidates({ paths, bbox, strategy, constraints = {}, mockId }) {
  ...
  const calcComplexity = /* @__PURE__ */ __name((g) => Math.min(1, (g.lines.length + g.circles.length) * 0.05), "calcComplexity");
  const autoCand = {
...
// ../src/lib/vectorize/provider.mjs
var MOCK_VECTOR_SVG = `
...
// ../.wrangler/tmp/pages-eNU87O/functionsRoutes-0.9626181361548953.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-HA5XGM/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-HA5XGM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.42011320823289156.mjs.map
